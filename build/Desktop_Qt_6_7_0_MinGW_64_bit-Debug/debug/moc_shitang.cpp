/****************************************************************************
** Meta object code from reading C++ file 'shitang.h'
**
...
#error "The header file 'shitang.h' doesn't include <QObject>."
...
void Form::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Form::*)();
            if (_t _q_method = &Form::back; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
